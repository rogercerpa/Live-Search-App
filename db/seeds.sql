...
VALUES
    ('Setting up sequelize', 'Setting up sequelize', '1:10', true, 'Shows how to set up sequelize', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/04-Supplemental', NOW(), NOW()),
    ('Setting up sequelize on bash terminal.', 'Setting up sequelize on bash terminal.', '6:51', true, 'Commands on terminal to set up sequelize project', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/04-Supplemental', NOW(), NOW()),
    ('07-ORM-To-Sequelize', 'Briefly going over object model of sequelize', '8:34', false, 'Object model for sequelize', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ('03-Chirpy-Sequelize', 'Chirpy Sequelize', '12:31', false, 'How to manipulate/define sequelize objects', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/03-Chirpy-Sequelize', NOW(), NOW()),
    ('04-StarWars', 'Star Wars', '14:19', false, '.GET with specific parameters', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/04-StarWars', NOW(), NOW()),
    ('07-ORM-To-Sequelize', 'To do list application', '16:00', true, 'starting to do list app', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master', NOW(), NOW()),
    ('07-ORM-To-Sequelize', '07-ORM-To-Sequelize', '22:15', false, 'Changing it so it works with Sequelize.  Deleting ORM methods and such.', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ('07-ORM-To-Sequelize', '07-ORM-To-Sequelize', '27:13', true, 'Npm install both mysql2 and sequelize for sequelize to work', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ...
    ('07-ORM-To-Sequelize', '07-ORM-To-Sequelize', '36:23', true, 'Instructor talks about index.js file inside models folder.  Index.js file never needs to be edited.', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ('07-ORM-To-Sequelize', '07-ORM-To-Sequelize', '41:26', true, 'How to define model in sequelize.', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ('07-ORM-To-Sequelize', '07-ORM-To-Sequelize', '59:38', true, 'Setting up sequelize object(Tables).', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ('07-ORM-To-Sequelize', '07-ORM-To-Sequelize', '1:01:18', true, 'Linking server.js to database', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/07-ORM-To-Sequelize', NOW(), NOW()),
    ('08-Sequelize-Create-Read', '08-Sequelize-Create-Read', '1:31:24', true, 'https://sequelize.org/v5/  Call db variables from defined sequelize object in todo.js example.', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/08-Sequelize-Create-Read', NOW(), NOW()),
    ('08-Sequelize-Create-Read', '08-Sequelize-Create-Read', '1:35:00', true, 'Get and post on api-routes.js  C.R of C.R.U.D', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/08-Sequelize-Create-Read', NOW(), NOW()),
    ('09-Sequelize-Update-Delete', '09-Sequelize-Update-Delete', '1:47:34', true, '.delete and .put  U.D of C.R.U.D', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/09-Sequelize-Update-Delete', NOW(), NOW()),
    ('09-Sequelize-Update-Delete', '09-Sequelize-Update-Delete', '2:29:31', true, 'Goes over .delete and .put for sequelize', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/09-Sequelize-Update-Delete', NOW(), NOW()),
    ('09-Sequelize-Update-Delete', '09-Sequelize-Update-Delete', '2:39:50', true, 'Recap of .delete .put', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/09-Sequelize-Update-Delete', NOW(), NOW()),
    ('09-Sequelize-Update-Delete', '09-Sequelize-Update-Delete', '2:59:52', true, 'Validation to prevent funky glitches on application using sequelize.define to create validations', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/09-Sequelize-Update-Delete', NOW(), NOW()),
    ('10-Sequelize-Validations', '10-Sequelize-Validations', '3:06:57', true, 'Using .catch(err => console.log(err)); to get rid of red validation error on terminal, just to make it look better when it outputs.', 'https://gt.bootcampcontent.com/GT-Coding-Boot-Camp/GT-ATL-FSF-PT-11-2019-U-C/tree/master/14-Full-Stack/01-Activities/10-Sequelize-Validations', NOW(), NOW());
...
VALUES
    ...
    ('First Server', 'Server, nodejs,Http library,port
...
INSERT INTO OOP
    (activity_name, main_topic, time_location, homework, hint_comment, folder, createdAt, updatedAt)
VALUES
